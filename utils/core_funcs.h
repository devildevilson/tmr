...
namespace devils_engine {
  ...
  namespace core {
    ...
    // функции атаки придется видимо сделать на колбеках
    // иначе непонятно когда че вызывать
    ...
    // глобальная функция плоха тем что создает конфликт при использовании модов
    // если у нас будет единственная функция для какого то действия, то любой мод практически всегда будет ее перезаписывать
    // поэтому лучше будет все же сделать коллбеки
