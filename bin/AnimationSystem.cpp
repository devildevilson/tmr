...
//Animation::Animation();
Animation::Animation(const AnimType &type, const size_t &animTime, const size_t &textureOffset, const size_t &animSize) : type(type), frameTime(animTime), textureOffset(textureOffset), animSize(animSize) {}
